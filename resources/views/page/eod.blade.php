        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img style="width:100%; height: auto" src="../image/eodpage01.jpg" alt="">
                </div>
                <div class="swiper-slide">
                  <img style="width:100%; height: auto" src="../image/eodpage02.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>엑스트라오디너리데이</h3>
              <ul>
                <li><strong>품목보고번호</strong>: 20140086585563</li>
                <li><strong>원재료명</strong>: 사과 38%, 히비스커스 24.5%<br>로즈힙 20%, 파인애플큐브 10%<br>계피
								5%, 해바라기꽃잎 2%<br>합성향료(배향)</li>
            ...
            <div class="portfolio-description">
              <h2>EXTRA ORDINARY DAY</h2>
              <p>
       			달콤한 배와 기품 있는 향의 시나몬을블렌딩한 새콤한 맛의 차
              </p>
            </div>
          </div>
